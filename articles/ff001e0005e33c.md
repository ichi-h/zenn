...
簡単な仕組みを解説いたしますと、Rook Ceph では **Operator** と呼ばれる CephCluster などの **Ceph CRs（Custom Resources）** を監視・制御する仕組みが提供されています。  
そして同様に提供されている Ceph CRs を用いることで、Ceph のデーモンがどのように稼働すべきかを宣言的に定義することができます。  
