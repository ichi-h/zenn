...
一方で、本記事は技術のミクロな使い方や導入方法を省略しているにも関わらず、NixOS と Kubernetes という学習コストの高い技術を同時に扱う都合上、本記事のマークダウンファイルの行数は **1400 行弱**、文字数は**4 万文字**を超えるという、**ギリギリ短編小説の枠に収まる**くらいの特大技術記事となってしまいました。  
現時点でも読み手にとって負担が大きい記事であるにもかかわらず、これ以上文字数を増やすわけにはいかないので、この点に関してはご了承いただけますと幸いです。
