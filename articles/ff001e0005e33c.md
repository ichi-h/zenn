...
そのため本記事の読み進め方として、各章は基本的に独立した形で執筆しておりますので、**気になる見出しからご覧いただくことを推奨いたします。**  
またこれ以上文量を増やさないために、**技術のミクロな使い方や導入方法を省略している箇所がございます**ので、この点はご容赦いただけますと幸いです。
...
また、サーバーの電源を必要なときだけ稼働させておきたいという気持ちがあったので、外出の際は Raspberry Pi を常時稼働させ、そこから各サーバーの電源を Wake-on-Lan で起こせるようにすることで、サーバーを使わないときは電源を落とせるようにしていました。
